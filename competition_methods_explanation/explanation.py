'''
Note that the rules produced by different competition methods are of various self-customized data structure.

I here provide a general form
'''
import re
...
class Explanation:
    ...
    def examples(self, only_different_prediction=False,
        ...
        if only_different_prediction and only_same_prediction:
            print('Error: you can\'t have only_different_predictionand only_same_prediction at the same time')
            return []
        key = 'covered'
